      ...
      >
        ...
        >
          <p
            ...
            style={{
              color: isBodyDecryptFailed ? '#ef4444' : '#4ade80',
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          <div className="flex items-center gap-4" style={{ whiteSpace: 'nowrap' }}>
            <button
              ...
              onMouseEnter={(event) => { if (!revealed) event.currentTarget.style.color = 'var(--text-primary)' }}
              onMouseLeave={(event) => { if (!revealed) event.currentTarget.style.color = 'var(--text-muted)' }}
            ...
            <button
              ...
              onMouseEnter={(event) => { if (revealed && !copied) event.currentTarget.style.color = 'var(--text-primary)' }}
              onMouseLeave={(event) => { if (!copied) event.currentTarget.style.color = 'var(--text-muted)' }}
